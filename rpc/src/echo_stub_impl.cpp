...
std::suspend_always
EchoService_MyStub::Echo(::PROTOBUF_NAMESPACE_ID::RpcController *controller,
...
std::suspend_always EchoService_MyStub::RelayEcho(
...
std::suspend_always
EchoService_MyStub::GetData(::PROTOBUF_NAMESPACE_ID::RpcController *controller,
